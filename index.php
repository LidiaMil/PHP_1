...
try {
    ...
    $em1 = new Employee($date, 1, "Ivan", 250);
    $em2 = new Employee($date, 21, "Petr", 356);
    $em3 = new Employee($date, 31, "Alex", 350);
    $em4 = new Employee($date, 41, "Alice", 252);
    $em5 = new Employee($date, 51, "Bob", 104);
    $em6 = new Employee($date, 61, "Richard", 356);
    $em7 = new Employee($date, 61, "Masood", 996);
    $em8 = new Employee($date, 61, "Lupa", 56);
